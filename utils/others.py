...
def save_score(k, name, mean_iou, mean_acc, dice, hd, date):
    ...
    csv_file = os.path.join('/home/chenxiaojing/PycharmProjects/CENet/results', date)
    mkfile(csv_file)
...
# import numpy as np
#
# im = Image.open("/home/chenxiaojing/PycharmProjects/CENet/v6/test/001-RS.jpg")
...
#
# im3 = im2.resize((width,height))
# print(im3.size)
# im3_array = np.asarray(im3)
#
# im_xor = im_array^im3_array
# print(np.all(im_xor)==0)
