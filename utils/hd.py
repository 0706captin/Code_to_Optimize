...
def Hausdorff_distance(i, image_root, gt_root, pred_root, name, date):
    ...
    save_dir = '/home/chenxiaojing/PycharmProjects/CENet/results/images/0915v1/k0/contours'
...
def save_hd_contours(k, date):
    ...
    root = '/home/chenxiaojing/PycharmProjects/CENet/results/images'
...
if __name__ == '__main__':
    hd_list, name = save_hd_contours(k=0, date='0915v1')
